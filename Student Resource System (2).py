...
headlabelfont = ("Century Gothic", 15, 'bold')
labelfont = ('Century Gothic', 14)
...
OptionMenu(left_frame, gender_strvar, 'Male', "Female", "Not to say").place(x=45, rely=0.49, relwidth=0.5)

dob = DateEntry(left_frame, font=("Arial", 12), width=15)
dob.place(x=20, rely=0.62)

Button(left_frame, text='Submit and Add Record', font=labelfont, command=add_record, width=25).place(relx=0.025, rely=0.85)
###################################################################
...
tree.column('#2', width=140, stretch=YES)
tree.column('#3', width=200, stretch=YES)
tree.column('#4', width=80, stretch=YES)
tree.column('#5', width=80, stretch=YES)
tree.column('#6', width=80, stretch=YES)
tree.column('#7', width=150, stretch=YES)
